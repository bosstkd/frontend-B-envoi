...
from '@angular/forms';
import { CalService } from '../add-depot/service/cal.service';
...
this.formData.montant = parseFloat((this.formData.poids * 50).toFixed(3));
    ...
    onSubmit(form:NgForm){
      ...
      if(this.data.bonIndex==null){
        console.log("my Values:", form.value);
          let myValues = form.value;
          console.log("my Values:", form.value);

          this.calService.poid = myValues['poids'];
          this.calService.destination = myValues['destination'];
